...
| ------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------: | ------ |
| **RF01**      | **O Agente de Acessibilidade** deve realizar login **por meio do preenchimento de suas credenciais**, **para acessar as funcionalidades do sistema**.                                                                                                       |       Alta |   Done     |
| **RF02**      | **O Agente de Acessibilidade** deve recuperar sua senha **por meio do fluxo de recuperação de senha**, **para restabelecer seu acesso ao sistema**.                                                                                                         |       Alta |   Done     |
...
| **RF04**      | **O Agente de Acessibilidade** deve cadastrar discentes **por meio de um formulário de cadastro**, **para registrar os estudantes no sistema e possibilitar seu acompanhamento**.                                                                            |       Alta |        |
...
| **RF07**      | **O Agente de Acessibilidade** deve visualizar os relatórios de acompanhamento cadastrados **por meio da listagem de relatórios**, **para consultar os registros associados aos discentes**.                                                                 |       Alta |        |
| **RF08**      | **O Agente de Acessibilidade** deve adicionar relatórios de acompanhamento **por meio de um formulário de registro**, **para documentar informações relacionadas ao acompanhamento dos discentes**.                                                        |       Alta |        |
| **RF09**      | **O Agente de Acessibilidade** deve editar relatórios de acompanhamento **por meio da funcionalidade de edição**, **para corrigir ou atualizar informações registradas**.                                                                                    |      Média |        |
...
| **RF11**      | **O Agente de Acessibilidade** deve visualizar os usuários cadastrados **por meio da listagem de usuários**, **para consultar os usuários registrados no sistema**.                                                                                           |      Baixa |        |
...
| **RF13**      | **O Agente de Acessibilidade** deve editar as informações dos usuários **por meio da funcionalidade de edição**, **para manter seus dados atualizados**.                                                                                                     |       Alta |        |
| **RF14**      | **O Agente de Acessibilidade** deve visualizar seu próprio perfil **por meio da área de perfil**, **para consultar seus dados cadastrados e informações de acesso**.                                                                                          |       Alta |        |
...
| **RF16**      | **O Agente de Acessibilidade** deve alterar sua senha **por meio da área de gerenciamento do perfil**, **para manter a segurança de suas credenciais de acesso**.                                                                                            |      Média |        |
| **RF17**      | **O Agente de Acessibilidade** deve registrar atendimentos e contribuições **por meio de um formulário de registro**, **para documentar as ações realizadas no acompanhamento dos discentes**.                                                               |      Média |        |
...
| **RF20**      | **O Agente de Acessibilidade** deve classificar as demandas dos discentes **por meio da seleção de categorias de acessibilidade**, **para organizar e identificar suas necessidades de acessibilidade**.                                                     |      Baixa |        |
| **RF21**      | **O sistema** deve registrar as operações realizadas pelo **Agente de Acessibilidade** **por meio de um histórico de auditoria**, **para possibilitar o rastreamento das ações executadas**.                                                                  |      Média |        |
| **RF22**      | **O Agente de Acessibilidade** deve filtrar as listagens de discentes, relatórios e usuários **por meio de critérios de busca e filtragem**, **para localizar registros específicos com maior facilidade**.                                                   |      Baixa |        |
---
